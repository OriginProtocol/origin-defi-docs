...
Anyone can trigger a rebase at any time by calling the **rebase** function on the [OUSD vault](../../smart-contracts/registry/ousd-registry.md) or [OETH vault](../../smart-contracts/registry/oeth-registry.md). You can do this on Etherscan by connecting a web3 wallet.
